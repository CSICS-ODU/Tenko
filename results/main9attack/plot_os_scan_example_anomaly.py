...
calls ``plot.plot_loss`` unchanged.
  ...
  MPLBACKEND=Agg .venv/bin/python results/main9attack/plot_os_scan_example_anomaly.py
  MPLBACKEND=Agg .venv/bin/python results/main9attack/plot_os_scan_example_anomaly.py --interval 1
"""
...
NPZ = HERE / "data" / "npz" / "OS Scan_scores.npz"
FIGS = HERE / "figs"
