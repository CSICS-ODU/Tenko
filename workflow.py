# NOTE: This workflow is a legacy diagnostic wrapper. Its X3/X4 layer rows
# are derived local estimates for development inspection only and are not used
# to generate the runtime measurements, tables, or figures reported in the paper.
# Paper runtime measurements are generated by measure_all_latency.py.
