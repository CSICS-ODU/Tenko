...
def load_model(load_mode, input_shape, scenario, train_loader, data, num_epochs):
    import os
    model_path = f'Models/{scenario}.pth'
    if load_mode == "new" or not os.path.exists(model_path):
        print(f"Training new model from scratch (model file not found: {model_path})")
